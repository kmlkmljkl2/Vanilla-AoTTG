...
public partial class TITAN : TitanBase
{
    ...
    {
        myLevel = level;
        myLevel = Mathf.Clamp(myLevel, 0.7f, 50f);
        ...
        else if (state == TitanState.attack)
        {
            if (attackAnimation == "combo")
            {
                ...
                if (base.animation["attack_" + attackAnimation].normalizedTime >= 0.11f && base.animation["attack_" + attackAnimation].normalizedTime <= 0.16f)
                {
                    ...
                    if (gameObject5 != null)
                    {
                        ...
                        if (IN_GAME_MAIN_CAMERA.GameType == GameType.Single)
                        {
                            gameObject5.GetComponent<HERO>().die((gameObject5.transform.position - position) * 15f * myLevel, isBite: false);
                        }
                ...
                if (base.animation["attack_" + attackAnimation].normalizedTime >= 0.27f && base.animation["attack_" + attackAnimation].normalizedTime <= 0.32f)
                {
                    ...
                    if (gameObject6 != null)
                    {
                        ...
                        if (IN_GAME_MAIN_CAMERA.GameType == GameType.Single)
                        {
                            gameObject6.GetComponent<HERO>().die((gameObject6.transform.position - position2) * 15f * myLevel, isBite: false);
                        }
            ...
            if (attackCheckTimeA != 0f && base.animation["attack_" + attackAnimation].normalizedTime >= attackCheckTimeA && base.animation["attack_" + attackAnimation].normalizedTime <= attackCheckTimeB)
            {
                if (leftHandAttack)
                {
                    ...
                    if (gameObject7 != null)
                    {
                        ...
                        if (IN_GAME_MAIN_CAMERA.GameType == GameType.Single)
                        {
                            gameObject7.GetComponent<HERO>().die((gameObject7.transform.position - position3) * 15f * myLevel, isBite: false);
                        }
                ...
                else
                {
                    ...
                    if (gameObject8 != null)
                    {
                        ...
                        if (IN_GAME_MAIN_CAMERA.GameType == GameType.Single)
                        {
                            gameObject8.GetComponent<HERO>().die((gameObject8.transform.position - position4) * 15f * myLevel, isBite: false);
                        }
            ...
            if (attackAnimation == "jumper_0" || attackAnimation == "crawler_jump_0")
            {
                ...
                if (gameObject10 != null)
                {
                    ...
                    if (IN_GAME_MAIN_CAMERA.GameType == GameType.Single)
                    {
                        gameObject10.GetComponent<HERO>().die((gameObject10.transform.position - position5) * 15f * myLevel, isBite: false);
                    }
            ...
            else
            {
                ...
                else if (abnormalType == AbnormalType.TYPE_CRAWLER)
                {
                    ...
                    if (gameObject13 != null)
                    {
                        ...
                        if (IN_GAME_MAIN_CAMERA.GameType == GameType.Single)
                        {
                            gameObject13.GetComponent<HERO>().die((gameObject13.transform.position - position6) * 15f * myLevel, isBite: false);
                        }
        ...
        else if (state == TitanState.to_check_point)
        {
            ...
            if (checkPoints.Count > 0)
            {
                ...
                else
                {
                    ...
                    Vector3 vector7 = (targetCheckPt = (Vector3)checkPoints[0]);
