...
public class BTN_save_snapshot : MonoBehaviour
{
	...
	private IEnumerator ScreenshotEncode()
	{
		...
		Texture2D texture = new Texture2D((int)(r * targetTexture.transform.localScale.x), (int)(r * targetTexture.transform.localScale.y), TextureFormat.RGB24, mipmap: false);
