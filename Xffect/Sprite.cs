...
public class Sprite
{
	...
	public void ResetSegment()
	{
		...
		ref Vector3 reference = ref pool.Vertices[vertStart];
		reference = Vector3.zero;
		ref Vector3 reference2 = ref pool.Vertices[vertStart + 1];
		reference2 = Vector3.zero;
		ref Vector3 reference3 = ref pool.Vertices[vertStart + 2];
		reference3 = Vector3.zero;
		ref Vector3 reference4 = ref pool.Vertices[vertStart + 3];
		reference4 = Vector3.zero;
		ref Color reference5 = ref pool.Colors[vertStart];
		reference5 = Color.white;
		ref Color reference6 = ref pool.Colors[vertStart + 1];
		reference6 = Color.white;
		ref Color reference7 = ref pool.Colors[vertStart + 2];
		reference7 = Color.white;
		ref Color reference8 = ref pool.Colors[vertStart + 3];
		reference8 = Color.white;
		ref Vector2 reference9 = ref pool.UVs[vertStart];
		reference9 = Vector2.zero;
		ref Vector2 reference10 = ref pool.UVs[vertStart + 1];
		reference10 = Vector2.zero;
		ref Vector2 reference11 = ref pool.UVs[vertStart + 2];
		reference11 = Vector2.zero;
		ref Vector2 reference12 = ref pool.UVs[vertStart + 3];
		reference12 = Vector2.zero;
	...
	public void UpdateUV()
	{
		...
		{
			ref Vector2 reference = ref pool.UVs[vertStart];
			reference = LowerLeftUV + Vector2.up * UVDimensions.y;
			ref Vector2 reference2 = ref pool.UVs[vertStart + 1];
			reference2 = LowerLeftUV;
			ref Vector2 reference3 = ref pool.UVs[vertStart + 2];
			reference3 = LowerLeftUV + Vector2.right * UVDimensions.x;
			ref Vector2 reference4 = ref pool.UVs[vertStart + 3];
			reference4 = LowerLeftUV + UVDimensions;
		}
		else
		{
			ref Vector2 reference5 = ref pool.UVs[vertStart];
			reference5 = LowerLeftUV;
			ref Vector2 reference6 = ref pool.UVs[vertStart + 1];
			reference6 = LowerLeftUV + Vector2.up * UVDimensions.y;
			ref Vector2 reference7 = ref pool.UVs[vertStart + 2];
			reference7 = LowerLeftUV + UVDimensions;
			ref Vector2 reference8 = ref pool.UVs[vertStart + 3];
			reference8 = LowerLeftUV + Vector2.right * UVDimensions.x;
		}
	...
	public void UpdateColor()
	{
		VertexPool pool = Vertexsegment.Pool;
		int vertStart = Vertexsegment.VertStart;
		ref Color reference = ref pool.Colors[vertStart];
		reference = Color;
		ref Color reference2 = ref pool.Colors[vertStart + 1];
		reference2 = Color;
		ref Color reference3 = ref pool.Colors[vertStart + 2];
		reference3 = Color;
		ref Color reference4 = ref pool.Colors[vertStart + 3];
		reference4 = Color;
